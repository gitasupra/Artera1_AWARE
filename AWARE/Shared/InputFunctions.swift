...
class InputFunctions : ObservableObject{
    ...
    func combine_features(csvPath: String) -> String? {
        ...
        // Manually define column types based on the data
    ...
    func create_per_second_data(file: String, metric_no: Int) -> String {
        ...
        let outputFileName = "\(FeatureType[Features(rawValue: metric_no)!]!)_all_per_sec_all_axis.csv"
    ...
    func create_per_window_data(file: String, metric_no: Int) -> String{
        ...
        do {
            ...
            _ = ["xMe", "xVr", "xMx", "xMi", "xUM", "xLM", "yMe", "yVr", "yMx", "yMn", "yUM", "yLM", "zMe", "zVr", "zMx", "zMi", "zUM", "zLM"]
